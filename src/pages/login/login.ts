  ...
  async login(user: User) {
    ...
    if(user.email == "" || user.password == "")
    {
      ...
      try {
        ...
        this.alert('Erro ao acessar a aplicação !', 'Informe o email ou a senha corretamente !');
      }
    }
  }
  ...
  async register(user: User) {
    ...
    {  
      ...
      try {
        ...
        this.alert('Erro ao efetuar o cadastro!',  'Informar o seus dados corretamente');
      }
    }
  }
